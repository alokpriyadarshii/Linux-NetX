...
async def lifespan(app: FastAPI):
    ...
    log.info("Starting Linux-Net Supervisor thread...")
    ...
    # Shutdown logic
    log.info("Stopping Linux-Net Supervisor...")
    g_supervisor.stop()


log.info("Starting Linux-Net Controller...")
app = FastAPI(
    title="Linux-Net Controller",
    description="Linux-Net Controller API",
    version=__version__,
...
def main():
    ...
    log.info("Starting Linux-Net Controller with Uvicorn...")
