...
from linux_net.plugins.templates import TemplateSource
from linux_net.plugins.templates.jinja2 import Jinja2Renderer
from linux_net.plugins.templates.jinja2.model import Jinja2RenderRequest
from linux_net.plugins.templates.textfsm import TextFSMTemplateParser
from linux_net.plugins.templates.textfsm.model import TextFSMParseRequest
from linux_net.plugins.templates.ttp import TTPTemplateParser
from linux_net.plugins.templates.ttp.model import TTPParseRequest
...
def test_template_source_http(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("linux_net.plugins.templates.requests.get", fake_get)
...
def test_template_source_ftp(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("linux_net.plugins.templates.urllib.request.urlopen", fake_urlopen)
