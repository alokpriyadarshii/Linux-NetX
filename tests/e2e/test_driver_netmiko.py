...
from linux_net.models import DriverName
from linux_net.plugins.drivers.netmiko import NetmikoDriver
from linux_net.plugins.drivers.netmiko.model import (
...
def test_netmiko_exec_on_linux_ssh():
    ...
    assert "linux_net-e2e" in res.stdout
...
def test_netmiko_exec_on_srlinux(monkeypatch):
    ...
    netmiko_module = sys.modules["linux_net.plugins.drivers.netmiko"]
