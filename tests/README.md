...
- 前置服务：Redis、Linux-Net API、RQ worker 与拓扑处于同一管理网可达。
- 默认节点：`ssh1` 172.20.20.21:2222（linux_net/linux_net），`redis1` 172.20.20.30:6379（无密码），`srl1/srl2` 172.20.20.11/12（admin/NokiaSrl1!）。
