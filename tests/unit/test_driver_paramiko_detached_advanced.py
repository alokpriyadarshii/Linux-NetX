...
from linux_net.models.common import FileTransferModel
from linux_net.models.driver import DriverExecutionResult
from linux_net.plugins.drivers.paramiko import ParamikoDriver
...
@patch("linux_net.plugins.drivers.paramiko.ParamikoDriver._handle_file_transfer")
