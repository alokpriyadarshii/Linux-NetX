# Linux-Net Webhook Test Server

A simple HTTP server for testing and debugging Linux-Net webhook functionality.

## Overview

This tool provides a lightweight HTTP server that can receive and display webhook messages from Linux-Net. It's designed to help developers test webhook configurations and debug webhook-related issues.
...
- **Error Parsing**: Intelligently parses and displays Linux-Net error messages
...
- Python 3.12+
- Linux-Net project dependencies
...
| `/webhook` | POST | Receive webhook messages from Linux-Net |
...
2. Configure Linux-Net to send webhooks to:
   ```
   http://localhost:8888/webhook
   ```

3. Execute a job in Linux-Net that triggers a webhook

4. Check the server logs to see the received webhook data

### Example Webhook Configuration

In your Linux-Net configuration, you can set up a webhook like this:
...
2024-01-15 10:30:45 - INFO - Linux-Net Webhook Request Details
2024-01-15 10:30:45 - INFO - ================================================================================
...
2024-01-15 10:30:45 - INFO -     user-agent: Linux-Net/1.0.0
...
{
  "status": "success",
  "message": "Linux-Net webhook message received (#1)",
...
4. Test with actual Linux-Net webhook data
...
This tool is part of the Linux-Net project and follows the same MIT license.