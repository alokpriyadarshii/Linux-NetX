...
Simple HTTP server for testing and debugging Linux-Net webhook functionality
"""
...
app = FastAPI(
    title="Linux-Net Webhook Test Server",
    description="Server for testing Linux-Net webhook functionality",
    version="1.0.0",
)
...
def log_request_details(request: Request, body: Dict[str, Any]) -> None:
    ...
    log.info("=" * 80)
    log.info("Linux-Net Webhook Request Details")
    log.info("=" * 80)
...
async def webhook_handler(request: Request):
    ...
    response = {
        "status": "success",
        "message": f"Linux-Net webhook message received (#{message_counter})",
        "timestamp": datetime.now().isoformat(),
...
async def health_check():
    return {
        "status": "healthy",
        "timestamp": datetime.now().isoformat(),
        "server": "Linux-Net Webhook Test Server",
        "version": "1.0.0",
    }
...
async def root():
    return {
        "service": "Linux-Net Webhook Test Server",
        "version": "1.0.0",
        "endpoints": {
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Linux-Net Webhook Test Server",
    ...
    print("Starting Linux-Net Webhook Test Server...")
