...
from linux_net.controller import app
...
def mock_storage_staging():
    ...
    test_staging = "/tmp/linux_net_test_staging"
    ...
    with (
        patch("linux_net.routes.storage.g_config") as mock_conf_storage,
        patch("linux_net.server.common.g_config") as mock_conf_auth,
    ):
